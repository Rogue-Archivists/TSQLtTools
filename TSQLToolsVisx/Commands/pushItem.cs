...
namespace TSQLtTools.Command
{
    ...
    public sealed class pushItem
    {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            var cmdId = new CommandID(PackageGuids.guidTSQLtToolsPackageCmdSet, PackageIds.PushItemID);
        ...
        private static void Execute(object sender, EventArgs e)
        {
            ...
            string message = $"Package: {_package.GetType().Name} inside {typeof(pushItem).FullName}";
            Logger.Log(message);
        }
    }
}
